<template>
  <div class="company-create bpo-dialog">
    <el-row :gutter="20">
      <el-col :span="8">
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="12">
        <el-input size="mini" readonly v-model="companyCode"/>
      </el-col>
    </el-row>
    <el-row :gutter="20">
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="12">
        <el-input size="mini" readonly v-model="companyName"/>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="8">
      ...
      <el-col :span="12">
        <el-input size="mini" readonly v-model="representativeName"/>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="8">
      ...
      <el-col :span="12">
        <el-input readonly size="mini" placeholder="（例）XX-XXXX-XXXX" v-model="representativePhoneName"/>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="8">
      ...
      <el-col :span="12">
        <el-input readonly size="mini" placeholder="（例）XX-XXXX-XXXX" v-model="representativeFaxCode"/>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="8">
