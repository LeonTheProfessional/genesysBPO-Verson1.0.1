<template>
  <div class="role-delete bpo-dialog">
    <el-row :gutter="20">
      <el-col :span="8">
        <span class="red-star">コード：</span>
      </el-col>
      <el-col :span="12">
        <el-input readonly :value="roleCode"/>
      </el-col>
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="12">
        <el-input readonly :value="roleName"/>
      </el-col>
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="12">
        <el-input readonly :value="systemName"/>
      </el-col>
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="12">
        <el-radio-group :value="validFlag">
      ...
      <el-col :span="16">
        <el-row>
          <el-col
            ...
            :span="7"
            :key="role.roleId">
            <el-tag style="margin-bottom: 10px">{{ role.roleName }}</el-tag>
          </el-col>
        </el-row>
      </el-col>
    </el-row>
